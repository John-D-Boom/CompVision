{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "mount_file_id": "https://github.com/John-D-Boom/CompVision/blob/main/testing_setup.ipynb",
      "authorship_tag": "ABX9TyMwgfas6wlfS9g/bI6ZOZ8n",
  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "HnTDC9Kxzvg5",
        "outputId": "42c802fe-5e72-4715-bd8a-81b9f891912c"
      },
      "execution_count": 19,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "pRfNusz9rYVX",
        "outputId": "bc878188-8ebe-4768-cdf3-6538883cde93"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "    \n",
        "    loss_history = {\"train\":[], \"val_different\":[], \"val_similar\":[]}\n",
        "\n",
        "\n",
        ...
        "                epoch_auc = metric(validation_pred_distance, validation_labels)\n",
        "                # print(\"after metrics\")\n",
        ...
        "                        epoch = num_epochs + 1 #sets epoch to greater than value in for loop, ending training\n",
        "\n",
        "        print()\n",
        "\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "LT3vpdvpk526",
        "outputId": "8afd3201-a065-40a1-f112-12ac2c4e7340"
      },
      "execution_count": 33,
      "outputs": [
        {
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "model_names = [\"resnet18\", \"resnet50\", \"resnet101\", \"alexnet\", \"vgg\", \"squeezenet\", \"densenet\", \"efficientnet\"]\n",
        "\n",
      ...
      "metadata": {
        ...
        "id": "1HoYTGJCoaV4",
        "outputId": "fb87894e-182e-4079-c749-9507f43430ff"
      },
