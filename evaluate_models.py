{
  ...
  "metadata": {
    "colab": {
      ...
      "authorship_tag": "ABX9TyPwb0CuNGRRRchm3Js7Nnw0",
  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "6fz15jkCjXoX",
        "outputId": "02ca0c3f-66b8-456d-ea3b-0411ad1ea786"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "        resnet50_64_state_dict_path = '/content/drive/MyDrive/MLMI/CompVision/tiny-imagenet-200/models/resnet50_64/best_auc_weights'\n",
        "        resnet50_64_state_dict = torch.load(resnet50_64_state_dict_path)\n",
        "        model_ft.load_state_dict(copy.deepcopy(resnet50_64_state_dict))\n",
        "\n",
        "        set_parameter_requires_grad(model_ft, feature_extract)\n",
        "\n",
        "        input_size = 224\n",
        "\n",
        "    elif model_name == \"resnet50_256\":\n",
        "        \"\"\" Resnet50_256\n",
        "        \"\"\"\n",
        "        model_ft = models.resnet50(pretrained=use_pretrained)\n",
        "        num_ftrs = model_ft.fc.in_features\n",
        ...
        "\n",
        "        resnet50_256_state_dict_path = '/content/drive/MyDrive/MLMI/CompVision/tiny-imagenet-200/models/resnet50_256/best_auc_weights'\n",
        "        resnet50_256_state_dict = torch.load(resnet50_256_state_dict_path)\n",
        "        model_ft.load_state_dict(copy.deepcopy(resnet50_256_state_dict))\n",
        "\n",
        "        set_parameter_requires_grad(model_ft, feature_extract)\n",
        "\n",
        "        input_size = 224\n",
        ...
        "        vit_state_dict_path = '/content/drive/MyDrive/MLMI/CompVision/tiny-imagenet-200/models/vit/best_auc_weights'\n",
        "        vit_state_dict = torch.load(vit_state_dict_path)\n",
        "        model_ft.load_state_dict(copy.deepcopy(vit_state_dict))\n",
        "\n",
        "        set_parameter_requires_grad(model_ft, feature_extract)\n",
        "        \n",
        "        input_size = 224\n",
        "\n",
        "    elif model_name == \"vit_64\":\n",
        "        \"\"\"Vision Transformer\n",
        "        \"\"\"\n",
        "        model_ft = timm.create_model('vit_base_patch16_224', pretrained=True, num_classes=64)\n",
        "        vit_64_state_dict_path = '/content/drive/MyDrive/MLMI/CompVision/tiny-imagenet-200/models/vit_64/best_auc_weights'\n",
        "        vit_64_state_dict = torch.load(vit_64_state_dict_path)\n",
        "        model_ft.load_state_dict(copy.deepcopy(vit_64_state_dict))\n",
        "\n",
        "        set_parameter_requires_grad(model_ft, feature_extract)\n",
        "\n",
        "        input_size = 224\n",
        "\n",
        "\n",
        "    elif model_name == \"vit_32\":\n",
        "        \"\"\"Vision Transformer\n",
        "        \"\"\"\n",
        "        model_ft = timm.create_model('vit_base_patch16_224', pretrained=True, num_classes=32)\n",
        "        vit_32_state_dict_path = '/content/drive/MyDrive/MLMI/CompVision/tiny-imagenet-200/models/vit_32/best_auc_weights'\n",
        "        vit_32_state_dict = torch.load(vit_32_state_dict_path)\n",
        "        model_ft.load_state_dict(copy.deepcopy(vit_32_state_dict))\n",
        "\n",
        "        set_parameter_requires_grad(model_ft, feature_extract)\n",
        "\n",
        "        input_size = 224\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Cch7T_Lbc0vc",
        "outputId": "08f5b7bf-d9f8-4fdd-9498-f641c0cf5205"
      },
      "execution_count": 20,
      "outputs": [
        {
    ...
    },
    {
      ...
      "source": [
        ...
        "        transforms.ToTensor(),\n",
        "        transforms.Resize((64, 64)), #I do this to downsample the higher resolution images from imagenet-o to ensure comparing apples to apples\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "22941a9c-91cd-48a9-e718-0e204243f319"
      },
      "execution_count": 24,
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "vit_64 has an optimal threshold of 0.39142814\n",
            "vit_32 has an optimal threshold of 0.5107759\n"
          ]
        }
      ]
    },
    ...
    },
    {
      ...
      "source": [
        ...
        "    all_accuracies = []\n",
        "    # model_names = [\"resnet18\", \"resnet50\", \"alexnet\", \"squeezenet\", \"efficientnet\", \"vit\", \"resnet50_64\", \"resnet50_256\"]\n",
        "    # model_names = [ \"vit\", \"resnet50_64\", \"resnet50_256\"]\n",
        "    model_names = [\"vit_64\", \"vit_32\"]\n",
        "\n",
        "\n",
        "    for model_name in model_names:\n",
        ...
        "    accuracy_df.to_csv('/content/drive/MyDrive/MLMI/CompVision/tiny-imagenet-200/models/model_accuracies_vit_dif_sizes.csv', index = False)"
      ],
      "metadata": {
        "id": "kUvbt8JRzFL6"
      },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "4PphP4IEGM2N",
        "outputId": "d0f313a4-dc3e-476d-ce18-ae286f70d191"
      },
      "execution_count": 27,
      "outputs": [
        {
          ...
          "text": [
            ...
            "7800\n",
            "4499\n",
            "dataloader_dict: {'test_seen_similar': <torch.utils.data.dataloader.DataLoader object at 0x7f7ee5d0dd60>, 'test_unseen_similar': <torch.utils.data.dataloader.DataLoader object at 0x7f7ee5d0d460>, 'test_imagenetO_similar': <torch.utils.data.dataloader.DataLoader object at 0x7f7ee5d0dee0>, 'test_seen_seen_different': <torch.utils.data.dataloader.DataLoader object at 0x7f7edf367070>, 'test_unseen_seen_different': <torch.utils.data.dataloader.DataLoader object at 0x7f7ee5d20340>, 'test_unseen_unseen_different': <torch.utils.data.dataloader.DataLoader object at 0x7f7ee5cbcf40>, 'test_imagenetO_different': <torch.utils.data.dataloader.DataLoader object at 0x7f7faf26f580>}\n",
            "vit_64\n",
            "test_seen_similar\n",
            "test_unseen_similar\n",
            "test_imagenetO_similar\n",
            "test_seen_seen_different\n",
            "test_unseen_seen_different\n",
            "test_unseen_unseen_different\n",
            "test_imagenetO_different\n"
          ]
        },
        {
          "output_type": "stream",
